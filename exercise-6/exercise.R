...
setwd("C:/Users/iguest.IS-M082L23-21.001/Desktop/ch9-dataframes/exercise-6")
husky.games.2016 <- read.csv('C:/Users/iguest.IS-M082L23-21.001/Desktop/ch9-dataframes/exercise-6/data/huskies_2016.csv', stringsAsFactors = FALSE)
...
# Create a variables called `combined.yards` that is the total yardage of the Huskies for each game
combined.yards <- rushing.yards + passing.yards

# What is the score of the game where the Huskies had the most combined yards?
score.most.yards <- husky.games.2016["uw.score",]
